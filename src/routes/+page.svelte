...
<div class="w-full p-4 space-y-4">
	<div class="text-center space-y-2">
		<p class="text-xl text-zinc-700 font-bold tracking/tighter leading/none">Mathew 5:8</p>
	...
	<div class="flex flex-col gap-5">
		<div class="grid grid-cols-2">
			<img
				src="/atim.jpg"
				alt="Madam Atim Bassey Hogan in pink traditional wear, in a sitting posture, "
				class="mx-auto rounded-lg object-cover"
				style="width: 79%; object-fit: contain;"
			/>
			<div class="md:space-y-7 space-y-2">
				<p class="text-lg text-yellow-700 md:text-2xl font-bold">1941 - 2023</p>
				<!-- <p class="text-lg leading-none">
          With submission to the Will of God, we announce the home call of our dear mother</p>-->
				<p class="md:text-7xl text-2xl font-bold">Madam Atim Bassey Hogan</p>
			...
			<div class="space-y-4">
				<div class="grid grid-cols-2 gap-3 text-xs">
					<div class="flex items-center space-x-1">
						...
						</svg><span class="text-xl">Saturday, 9th, March, 2024</span>
					</div>
					<div class="flex items-center space-x-1">
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						</svg><span class="text-xl">11:00am</span>
					</div>
				</div>
				<div class="flex items-baseline space-x-1">
					...
					</svg><span class="text-xl"
						>Edem Bassey Hogan's compound, Ikot Akwa Effiom Edem, Akpabuyo</span
					>
				</div>
			</div>
			<img
				src="/map.jpg "
				alt="A map showing directions to Edem Bassey Hogan's compound"
		...
		<div class="flex items-center space-x-1">
			...
			<span class="text-lg text-center font-semibold leading/snug">
